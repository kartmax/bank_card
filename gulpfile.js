...
function func_imagemin () {
	return src(['app/img/**/*+(.png|jpg|ico|svg)', '!app/img/for-sprite-svg/*', '!app/img/for-sprite-png/*'])
	.pipe(newer('app/img/**/*+(.png|jpg|ico|svg)', '!app/img/for-sprite-svg/*', '!app/img/for-sprite-png/*'))
	.pipe(cache(imagemin()))
	.pipe(dest('dist/img'))
}
